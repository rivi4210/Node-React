...
const LessoList = () => {
    ...
    // const [deleteLesson, { isErrorDel, isSuccessDel, errorDel }] = useDeleteLessonMutation()
    ...
    //     console.log({ _id, category, level })
    //     updatedLesson({ _id, category, level })
    //     // claer()
